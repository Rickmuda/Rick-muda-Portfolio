...
import { faUser, faFolder, faEnvelope, faShareNodes, faGamepad, faPalette, faCog, faCube } from "@fortawesome/free-solid-svg-icons";
...
library.add(faUser, faFolder, faEnvelope, faShareNodes, faGamepad, faPalette, faCog, faCube);
